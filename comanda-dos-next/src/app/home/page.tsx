...
import { VARS_EMPRESAS } from '../../tools/helpers/Helpers'
import { userData } from '../../tools/helpers/DataOfUser';
import Spinner from '../../tools/tools/Spinner'
import { animated } from '@react-spring/web';
import OutsideClickHandler from 'react-outside-click-handler';
import { useTransition } from '@react-spring/core';

import Cocinando from '@/tools/img/cocinando.png'
import Entregado from '@/tools/img/entregado.png'
import EntregadoPrendido from '@/tools/img/entregadoPrendido.png'
import Ordenado from '@/tools/img/ordenado.png'

import comanda from '@/tools/img/comanda.png'
import mesa from '@/tools/img/mesa.png'

// import sonidoUno from '/public/sounds/sonidoUno.mp3'
// import sonidoDos from '@/tools/sounds/sonidoDos.mp3'

const Home = ({ tokenOptions, reload }) => {

    // const sonidoUno = new Audio('/sounds/sonidoUno.mp3')
    ...
    const reloadData = () => {
        ...
        axios.get('api/comanda/all/comandas', { withCredentials: true })
            .then(res => {
